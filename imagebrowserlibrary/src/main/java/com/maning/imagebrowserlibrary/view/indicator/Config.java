...
public class Config {
    ...
    int margin = -1;
    @AnimatorRes
    int animatorResId = R.animator.mn_browser_indicator_scale;
    @AnimatorRes
    int animatorReverseResId = 0;
    @DrawableRes
    int backgroundResId = R.drawable.mn_browser_indicator_bg_selected;
    @DrawableRes
    int unselectedBackgroundId = R.drawable.mn_browser_indicator_bg_unselected;
